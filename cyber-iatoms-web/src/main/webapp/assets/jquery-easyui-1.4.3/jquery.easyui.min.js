...
/**
 * 对html标签進行反轉義，在打開編輯的時候
 */
function HTMLEenncode(value) {
	//只處理類型為string的內容
	if (typeof (value) == 'string') {
		//替換html標籤
...
$(_72d)[name]("setValue",HTMLEenncode(_72e));
}
}else{
$(_72d).val(_72e);
}
...
if(col.formatter){
cc.push(col.formatter(HTMLEncode(_794),_791,_790));
}else{
cc.push(HTMLEncode(_794));
}
}
cc.push("</div>");
cc.push("</td>");
