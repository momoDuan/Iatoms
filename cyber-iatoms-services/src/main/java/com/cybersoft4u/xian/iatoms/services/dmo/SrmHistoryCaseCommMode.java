 ...
 */
public class SrmHistoryCaseCommMode extends DomainModelObject<String, SrmCaseCommModeDTO>{

	private String id;
	private String caseId;
	private String commModeId;
	
	public SrmHistoryCaseCommMode() {
	}

	public SrmHistoryCaseCommMode(String id) {
		this.id = id;
	}

	public SrmHistoryCaseCommMode(String id, String caseId, String commModeId) {
		this.id = id;
		this.caseId = caseId;
