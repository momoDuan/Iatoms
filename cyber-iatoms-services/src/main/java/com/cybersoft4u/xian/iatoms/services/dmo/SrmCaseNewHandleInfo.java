...
/**
 * SrmCaseNewHandleInfo generated by hbm2java
 */
public class SrmCaseNewHandleInfo extends DomainModelObject<String, SrmCaseHandleInfoDTO>{
	...
	public SrmCaseNewHandleInfo() {
	}

	public SrmCaseNewHandleInfo(String caseId, String caseCategory) {
		this.caseId = caseId;
	...
	public SrmCaseNewHandleInfo(String caseId, String caseCategory,
			...
			Date installCompleteDate, String installedPostCode, String contactPostCode,
			String receiptType) {
		super();
		this.caseId = caseId;
		this.caseCategory = caseCategory;
