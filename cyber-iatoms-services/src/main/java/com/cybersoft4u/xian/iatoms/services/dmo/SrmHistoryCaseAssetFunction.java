...
/**
 * SrmHistoryCaseAssetFunction generated by hbm2java
 */
public class SrmHistoryCaseAssetFunction extends DomainModelObject<String, SrmCaseAssetFunctionDTO>{
	...
	public SrmHistoryCaseAssetFunction() {
	}

	public SrmHistoryCaseAssetFunction(String id) {
		this.id = id;
	}
