...
public class BimDepartment extends DomainModelObject<String,BimDepartmentDTO> {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5401157063486548854L;
	 ...
	 * Constructor:無參構造函數
	 */
	public BimDepartment() {
	}

	public BimDepartment(String deptCode) {
		this.deptCode = deptCode;
	}

	public BimDepartment(String deptCode, String companyId, String deptName,
