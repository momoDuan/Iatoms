...
import com.cybersoft4u.xian.iatoms.common.bean.dto.DmmRepositoryHistoryMonthlyDTO;

import cafe.core.dmo.DomainModelObject;

/**
 * DmmRepositoryHistoryMonthly generated by hbm2java
 */
public class DmmRepositoryHistoryMonthly extends DomainModelObject<DmmRepositoryHistoryMonthlyId,DmmRepositoryHistoryMonthlyDTO> {


	private DmmRepositoryHistoryMonthlyId id;
	...
	public DmmRepositoryHistoryMonthly() {
	}

	public DmmRepositoryHistoryMonthly(DmmRepositoryHistoryMonthlyId id,
			String isCup, String assetInId, String createUser,
			String createUserName, Date createDate,
			String updateUser, String updateUserName,
			Date updateDate) {
		this.id = id;
		this.isCup = isCup;
	...
	public DmmRepositoryHistoryMonthly(DmmRepositoryHistoryMonthlyId id,
			String serialNumber, String assetTypeId, String propertyId,
			String warehouseId, String contractId, String maType,
			String status, String isEnabled, Date enableDate,
			Date simEnableDate, String simEnableNo, String carrier,
			Date carryDate, String borrower, Date borrowerStart,
			Date borrowerEnd, String borrowerEmail, String borrowerMgrEmail,
			Date backDate, String assetOwner, String assetUser, String isCup,
			String retireReasonCode, String caseId, Date caseCompletionDate,
			String tid, String dtid, String applicationId, String merchantId,
			String assetInId, Date assetInTime, String assetTransId,
			String maintainCompany, String repairVendor, String description,
			String action, String faultComponent, String faultDescription,
	...
	public DmmRepositoryHistoryMonthlyId getId() {
		return this.id;
	}

	public void setId(DmmRepositoryHistoryMonthlyId id) {
		this.id = id;
	}
