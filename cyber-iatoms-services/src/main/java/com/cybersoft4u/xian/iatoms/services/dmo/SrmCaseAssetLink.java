...
/**
 * SrmCaseAssetLink generated by hbm2java
 */
public class SrmCaseAssetLink extends DomainModelObject<String, SrmCaseAssetLinkDTO>{
	...
	public SrmCaseAssetLink() {
	}

	public SrmCaseAssetLink(String assetLinkId) {
