 ...
 */
public class DmmAssetInList extends DomainModelObject<String,AssetInListDTO> {
	...
	public DmmAssetInList() {
	}

	public DmmAssetInList(String id) {
		this.id = id;
	}

	public DmmAssetInList(String id, String assetInId,
