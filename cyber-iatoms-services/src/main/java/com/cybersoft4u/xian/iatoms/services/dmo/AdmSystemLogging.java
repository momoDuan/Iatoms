...
public class AdmSystemLogging extends DomainModelObject<Integer, AdmSystemLoggingDTO> {
	 ...
	 * Constructor: 構造函數
	 */
	public AdmSystemLogging(Integer id) {
		super(id);
		this.id = id;
	}
	 ...
	 * Constructor:
	 */
	public AdmSystemLogging(String userId, Timestamp operationTime, String ip, String logCategre, String functionName,
			String content, String result, String sessionId, String clientInfo) {
		super();
		this.userId = userId;
