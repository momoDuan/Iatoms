 ...
 */
public class SrmCaseCommMode extends DomainModelObject<String, SrmCaseCommModeDTO>{

	private String id;
	private String caseId;
	private String commModeId;
	
	public SrmCaseCommMode() {
	}

	public SrmCaseCommMode(String id) {
		this.id = id;
	}

	public SrmCaseCommMode(String id, String caseId, String commModeId) {
		this.id = id;
		this.caseId = caseId;
