...
/**
 * SrmCaseHandleInfo generated by hbm2java
 */
public class SrmCaseHandleInfo extends DomainModelObject<String, SrmCaseHandleInfoDTO>{
	...
	public SrmCaseHandleInfo() {
	}

	public SrmCaseHandleInfo(String caseId, String caseCategory) {
		this.caseId = caseId;
	...
	public SrmCaseHandleInfo(String caseId, String caseCategory,
			...
			String isUpdateAsset, String completeDepartmentId,
			String hasOnlineExclusion, String firstDescription,
			String secondDescription, String thirdDescription,
			String hasRetreat, String hasDelay,
			...
			String contactUserEmail, String cmsCase, String confirmAuthorizes,
			String installCaseId, Date installCompleteDate,
			String isIatomsCreateCms, String preloadSerialNumber,
			String simSerialNumber, String installedPostCode,
			String contactPostCode, String hasArrive, String logisticsVendor,
