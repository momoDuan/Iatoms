...
/**
 * SrmCaseNewAssetLink generated by hbm2java
 */
public class SrmCaseNewAssetLink extends DomainModelObject<String, SrmCaseAssetLinkDTO>{
	...
	public SrmCaseNewAssetLink() {
	}

	public SrmCaseNewAssetLink(String assetLinkId) {
